...
def test_runtime_endpoint_refresh_collects_candidates_from_all_public_resolvers(monkeypatch):
    def fake_getaddrinfo(*_args, **_kwargs):
        return []
    ...
    endpoints = proxy_master._refresh_real_upstream_endpoints('assetdelivery.roblox.com')
