...
def test_rgba8_ktx2_writes_full_level_index_smallest_level_first(tmp_path):
    rgba = bytes(range(64))
...
def test_linear_mip_generation_uses_box_average_with_nearest_even_rounding():
    rgba = bytes((
        0, 0, 0, 0,
        1, 0, 255, 255,
        2, 1, 0, 0,
...
def test_color_mip_generation_filters_rgb_in_gamma2_space():
    rgba = bytes((
        0, 0, 0, 0,
        255, 255, 255, 255,
        0, 0, 0, 0,
...
def test_normal_mip_generation_bilinearly_filters_and_renormalizes_vectors():
    rgba = bytes((
        255, 128, 128, 0,
        128, 255, 128, 255,
        255, 128, 128, 0,
...
def test_normal_mips_are_resampled_directly_from_base_level():
    rgba = bytes((
        255, 128, 128, 255, 128, 255, 128, 255, 128, 128, 255, 255, 0, 128, 128, 255,
        128, 0, 128, 255, 128, 128, 0, 255, 220, 180, 180, 255, 60, 190, 180, 255,
        200, 100, 180, 255, 100, 220, 160, 255, 160, 80, 230, 255, 180, 180, 180, 255,
        80, 80, 230, 255, 230, 80, 160, 255, 80, 230, 160, 255, 128, 128, 255, 255,
    ))
...
def test_explicit_rgba8_mips_round_trip_without_regeneration(tmp_path):
    base = bytes(range(16))
