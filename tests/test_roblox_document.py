...
class RobloxDocumentTests(unittest.TestCase):
    def test_model_xml_exports_as_rbxm_or_rbxmx(self) -> None:
        self.assertEqual(classify_roblox_document(MODEL_XML), 'rbxmx')
        self.assertEqual(
            get_default_roblox_document_export_format(MODEL_XML), 'converted_document_rbxmx'
        )
        self.assertEqual(
        ...
        self.assertEqual(
            get_default_roblox_document_export_format(rbxm_data), 'converted_document_rbxm'
        )
    ...
    def test_xml_declaration_does_not_block_document_detection(self) -> None:
    ...
    def test_texturepack_xml_is_not_classified_as_rbxmx(self) -> None:
    ...
    def test_datamodel_document_exports_only_as_rbxl(self) -> None:
        self.assertEqual(classify_roblox_document(PLACE_XML), 'rbxl')
        self.assertEqual(
            get_default_roblox_document_export_format(PLACE_XML), 'converted_document_rbxl'
        )
        self.assertEqual(
    ...
    def test_place_asset_type_exports_only_as_rbxl_even_with_model_payload(self) -> None:
        self.assertEqual(
