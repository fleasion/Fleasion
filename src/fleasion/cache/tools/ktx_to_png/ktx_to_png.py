...
def _legacy_etc(  # ruff: ignore[too-many-positional-arguments]
    block: int,
    r0: int,
    g0: int,
    b0: int,
...
def _etc_t_h(  # ruff: ignore[too-many-positional-arguments]
    block: int,
    mode: int,
    dest: bytearray,
    base_offset: int,
...
def _decode_ktx2_etc(data: bytes) -> np.ndarray | None:  # ruff: ignore[too-many-return-statements]
